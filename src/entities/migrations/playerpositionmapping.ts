...
export class SeedPlayerPositionsAndMappings20250318121000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Insert static player positions
    ...
    await queryRunner.query(`
      ...
      VALUES 
        ...
        ('stamina', '', 30, (SELECT id FROM "player_position" WHERE code = 'TE')),
        ('injury', '', 31, (SELECT id FROM "player_position" WHERE code = 'TE'));
    `);
    ...
    await queryRunner.query(`
      ...
      VALUES 
        ...
        ('ball_carrier_vision', '', 11, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('catching', '', 12, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('stiff_arm', '', 13, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('spin_move', '', 14, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('juke_move', '', 15, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('pass_blocking', '', 16, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('catch_in_traffic', '', 17, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('spectacular_catch', '', 18, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('short_route_running', '', 19, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('medium_route_running', '', 20, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('release', '', 21, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('stamina', '', 22, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('return', '', 23, (SELECT id FROM "player_position" WHERE code = 'RB')),
        ('injury', '', 24, (SELECT id FROM "player_position" WHERE code = 'RB'));
    `);
    ...
    await queryRunner.query(`
      ...
      VALUES 
        ...
        ('change_of_direction', '', 5, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('strength', '', 6, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('awareness', '', 7, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('break_tackle', '', 8, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('catch_in_traffic', '', 9, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('spectacular_catch', '', 10, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('release', '', 11, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('jumping', '', 12, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('carrying', '', 13, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('trucking', '', 14, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('ball_carrier_vision', '', 15, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('catching', '', 16, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('stiff_arm', '', 17, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('spin_move', '', 18, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('juke_move', '', 19, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('short_route_running', '', 20, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('medium_route_running', '', 21, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('deep_route_running', '', 22, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('stamina', '', 23, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('return', '', 24, (SELECT id FROM "player_position" WHERE code = 'WR')),
        ('injury', '', 25, (SELECT id FROM "player_position" WHERE code = 'WR'));
    `);
    ...
    await queryRunner.query(`
      ...
      VALUES 
        ...
        ('acceleration', '', 3, (SELECT id FROM "player_position" WHERE code = 'DI')),
    ...
    await queryRunner.query(`
      ...
      VALUES 
        ...
        ('pursuit', '', 11, (SELECT id FROM "player_position" WHERE code = 'CB')),
        ('play_recognition', '', 12, (SELECT id FROM "player_position" WHERE code = 'CB')),
        ('man_coverage', '', 13, (SELECT id FROM "player_position" WHERE code = 'CB')),
        ('zone_coverage', '', 14, (SELECT id FROM "player_position" WHERE code = 'CB')),
        ('press', '', 15, (SELECT id FROM "player_position" WHERE code = 'CB')),
        ('return', '', 16, (SELECT id FROM "player_position" WHERE code = 'CB')),
        ('stamina', '', 17, (SELECT id FROM "player_position" WHERE code = 'CB')),
        ('injury', '', 18, (SELECT id FROM "player_position" WHERE code = 'CB'));
    `);
    ...
    await queryRunner.query(`
      ...
      VALUES 
        ...
        ('block_shedding', '', 9, (SELECT id FROM "player_position" WHERE code = 'S')),
    ...
    await queryRunner.query(`
      ...
      VALUES 
        ...
        ('pursuit', '', 12, (SELECT id FROM "player_position" WHERE code = 'EDGE')),
        ('play_recognition', '', 13, (SELECT id FROM "player_position" WHERE code = 'EDGE')),
        ('stamina', '', 14, (SELECT id FROM "player_position" WHERE code = 'EDGE')),
        ('injury', '', 15, (SELECT id FROM "player_position" WHERE code = 'EDGE'));
    `);
    ...
    await queryRunner.query(`
      ...
      VALUES 
        ...
        ('impact_block', '', 8, (SELECT id FROM "player_position" WHERE code = 'OT')),
        ...
        ('pass_block_finesse', '', 12, (SELECT id FROM "player_position" WHERE code = 'OT')),
    ...
    await queryRunner.query(`
      ...
      WHERE "positionId" IN (
        SELECT id FROM "player_position" WHERE code IN (
          'TE', 'QB', 'RB', 'WR', 'OL', 'DI', 'LB', 'CB', 'S', 'IOL', 'OT', 'EDGE'
        )
      )
    `);
