...
export class SeedPlayerPositionsAndMappings20250318121000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
   ...
   `);
    ...
    // For "TE"
    await queryRunner.query(`
      INSERT INTO "position_attribute_mapping" ("attributeKey",  "displayOrder", "positionId")
      VALUES 
    ...
    await queryRunner.query(`
      INSERT INTO "position_attribute_mapping" ("attributeKey",  "displayOrder", "positionId")
      VALUES 
        ('age',  1, (SELECT id FROM "player_position" WHERE code = 'K')),
        ('kick_power',  2, (SELECT id FROM "player_position" WHERE code = 'K')),
        ('awareness',  3, (SELECT id FROM "player_position" WHERE code = 'K')),
        ('kick_accuracy',  4, (SELECT id FROM "player_position" WHERE code = 'K')),
        ('acceleration',  5, (SELECT id FROM "player_position" WHERE code = 'K'))
    `);
    //------------P
    await queryRunner.query(`
      INSERT INTO "position_attribute_mapping" ("attributeKey",  "displayOrder", "positionId")
      VALUES 
        ('age',  1, (SELECT id FROM "player_position" WHERE code = 'P')),
        ('kick_power',  2, (SELECT id FROM "player_position" WHERE code = 'P')),
        ('awareness',  3, (SELECT id FROM "player_position" WHERE code = 'P')),
        ('kick_accuracy',  4, (SELECT id FROM "player_position" WHERE code = 'P')),
        ('acceleration',  5, (SELECT id FROM "player_position" WHERE code = 'P'))
    `);
    ...
    await queryRunner.query(`
      INSERT INTO "position_attribute_mapping" ("attributeKey",  "displayOrder", "positionId")
      VALUES 
        ('age',  1, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('speed',  2, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('acceleration',  3, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('agility',  4, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('stamina',  5, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('change_of_direction',  6, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('lead_block',  7, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('run_block',  8, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('pass_block',  9, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('pass_block_power',  10, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('run_block_power',  11, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('pass_block_finesse',  12, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('run_block_finesse',  13, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('carrying',  14, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('catching',  15, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('catch_in_traffic',  16, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('short_route_running',  17, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('medium_route_running',  18, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('injury',  19, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('strength',  20, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('impact_blocking',  21, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('stiff_arm',  22, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('trucking',  23, (SELECT id FROM "player_position" WHERE code = 'FB')),
        ('awareness',  24, (SELECT id FROM "player_position" WHERE code = 'FB'))
    `);
  }
