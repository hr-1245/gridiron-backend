      ...
      switch (obj.positionCode || obj.player_class) {
        ...
        case POSTION_CODE.QuarterBack:
          ...
          const convertedDataQB = {
            ...
            throw_power: this.clampAttribute(dataobj.throw_power, -3),
            throw_accuracy_short: this.clampAttribute(dataobj.throw_accuracy_short, -8, draft_round),
            throw_accuracy_mid: this.clampAttribute(dataobj.throw_accuracy_mid, -9, draft_round),
            throw_accuracy_deep: this.clampAttribute(dataobj.throw_accuracy_deep, -9, draft_round),
            throw_on_the_run: this.clampAttribute(dataobj.throw_on_the_run, -10, draft_round),
            throw_under_pressure: this.clampAttribute(dataobj.throw_under_pressure, -6, draft_round),
            play_action: this.clampAttribute(dataobj.play_action, -9, draft_round),
            break_sack: this.clampAttribute(dataobj.break_sack, -8, draft_round),
            break_tackle: this.clampAttribute(dataobj.break_tackle, -2, draft_round),
            trucking: this.clampAttribute(dataobj.trucking, -5, draft_round),
        ...
        case POSTION_CODE.RunningBack:
          ...
          const convertedDataRB = {
            age: calculatedAge,
            speed: this.clampAttribute(dataobj.speed, -3),
            acceleration: this.clampAttribute(dataobj.acceleration, -3),
            agility: this.clampAttribute(dataobj.agility, -6),
            change_of_direction: this.clampAttribute(dataobj.change_of_direction, -6),
            ...
            carrying: this.clampAttribute(dataobj.carrying, -4, draft_round),
            trucking: this.clampAttribute(dataobj.trucking, -4, draft_round),
            ball_carrier_vision: this.clampAttribute(dataobj.ball_carrier_vision, -8, draft_round),
            catching: this.clampAttribute(dataobj.catching, -11, draft_round),
            stiff_arm: this.clampAttribute(dataobj.stiff_arm, -1, draft_round),
            spin_move: this.clampAttribute(dataobj.spin_move, 0, draft_round),
            juke_move: this.clampAttribute(dataobj.juke_move, -2, draft_round),
            pass_blocking: this.clampAttribute(dataobj.pass_blocking, -12, draft_round),
            catch_in_traffic: this.clampAttribute(dataobj.catch_in_traffic, -15, draft_round),
            spectacular_catch: this.clampAttribute(dataobj.spectacular_catch, -6, draft_round),
            short_route_running: this.clampAttribute(dataobj.short_route_running, -13, draft_round),
            medium_route_running: this.clampAttribute(dataobj.short_route_running, -23, draft_round),
            release: this.clampAttribute(dataobj.release, -11, draft_round),
        ...
        case POSTION_CODE.WiderReceiver:
          ...
          const convertedDataWR = {
            ...
            acceleartion: this.clampAttribute(dataobj.acceleration, -1),
            agility: this.clampAttribute(dataobj.agility, -5),
            change_of_direction: this.clampAttribute(dataobj.change_of_direction, -5),
            strength: this.clampAttribute(dataobj.strength, -16),
            awareness: this.clampAttribute(dataobj.awareness, -12, draft_round),
            break_tackle: this.clampAttribute(dataobj.break_tackle, -12, draft_round),
            catch_in_traffic: this.clampAttribute(dataobj.catch_in_traffic, -8, draft_round),
            spectacular_catch: this.clampAttribute(dataobj.spectacular_catch, -10, draft_round),
            release: this.clampAttribute(dataobj.release, -16, draft_round),
            jumping: this.clampAttribute(dataobj.jumping, -5),
            carrying: this.clampAttribute(dataobj.carrying, -17, draft_round),
            trucking: this.clampAttribute(dataobj.trucking, -8, draft_round),
            ball_carrier_vision: this.clampAttribute(dataobj.ball_carrier_vision, -12, draft_round),
            catching: this.clampAttribute(dataobj.catching, -6, draft_round),
            stiff_arm: this.clampAttribute(dataobj.stiff_arm, -5, draft_round),
            spin_move: this.clampAttribute(dataobj.spin_move, -7, draft_round),
            juke_move: this.clampAttribute(dataobj.juke_move, -8, draft_round),
            short_route_running: this.clampAttribute(dataobj.short_route_running, -15, draft_round),
            medium_route_running: this.clampAttribute(dataobj.medium_route_running, -15, draft_round),
            deep_route_running: this.clampAttribute(dataobj.deep_route_running, -14, draft_round),
            stamina: this.clampAttribute(dataobj.stamina, -9),
            return: this.clampAttribute(dataobj.return, -2),
            injury: this.clampAttribute(dataobj.injury, -1)
          }
        ...
        case POSTION_CODE.LeftGuard:
          ...
          const convertedDataLG = {
            age: calculatedAge,
            speed: this.clampAttribute(dataobj.speed, 2),
            acceleartion: this.clampAttribute(dataobj.acceleration, -4),
            awareness: this.clampAttribute(dataobj.awareness, -7, draft_round),
            agility: this.clampAttribute(dataobj.agility, -15),
            lead_block: this.clampAttribute(dataobj.lead_block, -5, draft_round),
            impact_block: this.clampAttribute(dataobj.impact_blocking, -0, draft_round),
            run_block: this.clampAttribute(dataobj.run_blocking, -5, draft_round),
            pass_block: this.clampAttribute(dataobj.pass_blocking, -4, draft_round),
            pass_block_power: this.clampAttribute(dataobj.pass_block_power, -11, draft_round),
            pass_block_finesse: this.clampAttribute(dataobj.pass_block_finesse, -7, draft_round),
            run_block_power: this.clampAttribute(dataobj.run_block_power, -7, draft_round),
            run_block_finesse: this.clampAttribute(dataobj.run_block_finesse, -7, draft_round),
            stamina: this.clampAttribute(dataobj.stamina, -2),
        ...
        case POSTION_CODE.DefensiveTackle:
          ...
          const convertedDataDI = {
            age: calculatedAge,
            speed: this.clampAttribute(dataobj.speed, 0),
            acceleartion: this.clampAttribute(dataobj.acceleration, -7),
            agility: this.clampAttribute(dataobj.agility, 0),
            awareness: this.clampAttribute(dataobj.awareness, -6, draft_round),
            strength: this.clampAttribute(dataobj.strength, -2),
            tackling: this.clampAttribute(dataobj.tackling, -7, draft_round),
            hit_power: this.clampAttribute(dataobj.hit_power, -9),
            power_moves: this.clampAttribute(dataobj.power_moves, -10, draft_round),
            finesse_moves: this.clampAttribute(dataobj.finesse_moves, -5, draft_round),
            block_shed: this.clampAttribute(dataobj.block_shedding, -0, draft_round),
            pursuit: this.clampAttribute(dataobj.pursuit, -6, draft_round),
            play_recognition: this.clampAttribute(dataobj.play_recognition, -10, draft_round),
            stamina: this.clampAttribute(dataobj.stamina, -5),
            injury: this.clampAttribute(dataobj.injury, -2)
          }
        ...
        case POSTION_CODE.CornerBack:
          ...
          const convertedDataCB = {
            ...
            agility: this.clampAttribute(dataobj.agility, -6),
            catch_of_direction: this.clampAttribute(dataobj.change_of_direction, -5),
            catching: 'catching' in dataobj ? this.clampAttribute(dataobj.catching, -13, draft_round) : undefined,
            awareness: this.clampAttribute(dataobj.awareness, -14, draft_round),
            strength: this.clampAttribute(dataobj.strength, -8),
            jumping: this.clampAttribute(dataobj.jumping, -6),
            tackling: 'tackling' in dataobj ? this.clampAttribute(dataobj.tackling, -12, draft_round) : undefined,
            hit_power: this.clampAttribute(dataobj.hit_power, 0),
            pursuit: this.clampAttribute(dataobj.pursuit, -11, draft_round),
            play_recognition: this.clampAttribute(dataobj.play_recognition, -11, draft_round),
            man_coverage: this.clampAttribute(dataobj.man_coverage, -7, draft_round),
            zone_coverage: this.clampAttribute(dataobj.zone_coverage, -6, draft_round),
            press: this.clampAttribute(dataobj.press, -14, draft_round),
            return: this.clampAttribute(dataobj.return, 15),
            stamina: this.clampAttribute(dataobj.stamina, -9),
            injury: this.clampAttribute(dataobj.injury, -1)
          }
        ...
        case POSTION_CODE.Safety:
          ...
          const convertedDataS = {
            ...
            acceleration: this.clampAttribute(dataobj.acceleration, -5),
            agility: this.clampAttribute(dataobj.agility, -1),
            cod: this.clampAttribute(dataobj.change_of_direction, -10),
            catching: this.clampAttribute(dataobj.catching, -9, draft_round),
            awareness: this.clampAttribute(dataobj.awareness, -3, draft_round),
            strength: this.clampAttribute(dataobj.strength, 0),
            block_shed: 'block_shed' in dataobj ? this.clampAttribute(dataobj.block_shed, -0, draft_round) : undefined,
            jumping: this.clampAttribute(dataobj.jumping, -9),
            tackling: this.clampAttribute(dataobj.tackling, -7, draft_round),
            hit_power: this.clampAttribute(dataobj.hit_power, -2),
            pursuit: this.clampAttribute(dataobj.pursuit, -2, draft_round),
            play_recognition: this.clampAttribute(dataobj.play_recognition, -8, draft_round),
            man_coverage: this.clampAttribute(dataobj.man_coverage, -2, draft_round),
            zone_coverage: this.clampAttribute(dataobj.zone_coverage, -9, draft_round),
            press: this.clampAttribute(dataobj.press, -0, draft_round),
            stamina: this.clampAttribute(dataobj.stamina, -3),
            injury: this.clampAttribute(dataobj.injury, -3),
          }
        ...
        case POSTION_CODE.Kicker:
          ...
          const convertedDataK = {
            age: calculatedAge,
            kick_power: this.clampAttribute(dataobj.kick_power, -2),
            awareness: this.clampAttribute(dataobj.awareness, -9),
            kick_accuracy: this.clampAttribute(dataobj.kick_accuracy, -10),
            speed: this.clampAttribute(dataobj.speed, -3),
        ...
        case POSTION_CODE.Punter:
          ...
          const convertedDataP = {
            age: calculatedAge,
            kick_power: this.clampAttribute(dataobj.kick_power, -3),
            awareness: this.clampAttribute(dataobj.awareness, -21),
            kick_accuracy: this.clampAttribute(dataobj.kick_accuracy, -9),
            speed: this.clampAttribute(dataobj.speed, 0),
            acceleration: this.clampAttribute(dataobj.acceleration, 4),
          }
        ...
        case POSTION_CODE.FullBack:
          ...
          const convertedDataFB = {
            ...
            acceleration: this.clampAttribute(dataobj.acceleration, 5),
            agility: this.clampAttribute(dataobj.agility, 2),
            stamina: this.clampAttribute(dataobj.stamina, -7),
            change_of_direction: this.clampAttribute(dataobj.change_of_direction, -1),
            lead_block: this.clampAttribute(dataobj.lead_block, -3),
            run_block: this.clampAttribute(dataobj.run_block, -9),
            pass_block: this.clampAttribute(dataobj.pass_block, -5),
            pass_block_power: this.clampAttribute(dataobj.pass_block_power, -5),
            run_block_power: this.clampAttribute(dataobj.run_block_power, -6),
            pass_block_finesse: this.clampAttribute(dataobj.pass_block_finesse, -16),
            run_block_finesse: this.clampAttribute(dataobj.run_block_finesse, -4),
            carrying: this.clampAttribute(dataobj.carrying, -9),
            catching: this.clampAttribute(dataobj.catching, -1),
            catch_in_traffic: this.clampAttribute(dataobj.catch_in_traffic, -2),
            short_route_running: this.clampAttribute(dataobj.short_route_running, -10),
            medium_route_running: this.clampAttribute(dataobj.medium_route_running, -8),
            injury: this.clampAttribute(dataobj.injury, -2),
            strength: this.clampAttribute(dataobj.strength, 2),
            impact_block: this.clampAttribute(dataobj.impact_blocking, -8),
            stiff_arm: this.clampAttribute(dataobj.stiff_arm, 4),
            trucking: this.clampAttribute(dataobj.trucking, -5),
            awareness: this.clampAttribute(dataobj.awareness, -7),
          }
